...
export default function Tabs({ tabs }) {
  ...
  return (
      <>
          <div className="god-container grid grid-cols-6 h-screen " data-theme="black">
              <div className="left-section h-screen col-span-4 flex flex-col w-full p-2">
                  <div className="top-container flex justify-between items-center p-4 mb-2">
                      ...
                      <button
                          className="btn btn-outline font-bold hover:font-bold hover:bg-twitter-200 border-twitter-100 hover:border-twitter-200 uppercase"
                          onClick={() => {
